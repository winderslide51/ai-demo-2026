// DTOs mirroring the backend responses — see docs/SPEC-TECHNIQUE.md §5.
...
export type ProfilHoraire = { heure: number; moyenneKw: number }
...
export type Releve = { horodatage: string; kwh: number; plage: Plage }

export type Consommation = { siteId: string; mois: string; releves: Releve[] }
